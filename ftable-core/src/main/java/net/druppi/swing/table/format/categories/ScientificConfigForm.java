...
/**
 * Configuration panel of the ScientificCategory.
 *
 * @author Olivier Sechet
 * @version 1.0 - Apr 13, 2009
 */
@SuppressWarnings("serial")
class ScientificConfigForm extends ConfigPanel {
    ...
    private void initComponents() {
        ...
        decimalLabel.setText(ResourceManager.getResourceMap(getClass()).getString("ScientificConfigForm.decimalLabel.text")); // NOI18N
