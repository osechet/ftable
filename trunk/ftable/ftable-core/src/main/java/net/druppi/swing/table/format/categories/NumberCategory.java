...
/**
 * The NumberCategory is used with simple numbers.
 *
 * @author Olivier Sechet
 * @version 1.0 - Apr 10, 2009
 */
class NumberCategory extends AbstractCategory {
    ...
    /**
     * Creates a new NumberCategory.
     */
    public NumberCategory() {
        super(getResourceMap().getString("FormatListModel.number")); //$NON-NLS-1$
        format = new FormatWarpper(NumberFormat.getIntegerInstance());
        panel = new NumberConfigForm();
    }
