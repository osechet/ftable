...
public class CellFormatTest {
    ...
    /**
     * Test method for {@link net.druppi.swing.table.format.CellFormat#compareTo(java.lang.Object)}.
     */
    @Test
    public void testCompareTo() {
        ...
        assertFalse(f1.compareTo(f3) == 0);
        assertFalse(f1.compareTo(f4) == 0);
        assertFalse(f1.compareTo(f5) == 0);
        assertFalse(f1.compareTo(f6) == 0);
    }
