...
/**
 * Configuration panel of the NumberCategory.
 *
 * @author Olivier Sechet
 * @version 1.0 - Apr 13, 2009
 */
@SuppressWarnings("serial")
class NumberConfigForm extends ConfigPanel {

    /** The managed Format. */
    private NumberFormat format;

    /**
     * Creates new form NumberConfigForm.
     */
    public NumberConfigForm() {
        initComponents();
    }
    ...
    private void updateView() {
        ...
        separatorCheckBox.setSelected(format.isGroupingUsed());
    }
    ...
    private void initComponents() {
        ...
        decimalLabel.setText(ResourceManager.getResourceMap(getClass()).getString("NumberConfigForm.decimalLabel.text")); // NOI18N
        ...
        separatorCheckBox.setText(ResourceManager.getResourceMap(getClass()).getString("NumberConfigForm.separatorCheckBox.text")); // NOI18N
        separatorCheckBox.setName("separatorCheckBox"); // NOI18N
        separatorCheckBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent evt) {
                separatorCheckBoxItemStateChanged(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(Alignment.LEADING)
                    ...
                    .addComponent(separatorCheckBox))
    ...
    /**
     * Called when the state of the separator checkBox changes.
     *
     * @param evt an event.
     */
    private void separatorCheckBoxItemStateChanged(ItemEvent evt) {//GEN-FIRST:event_separatorCheckBoxItemStateChanged
        format.setGroupingUsed(true);

        firePropertyChange(MODIFIED, false, true);
    }//GEN-LAST:event_separatorCheckBoxItemStateChanged
